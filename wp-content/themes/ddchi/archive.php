...
get_header(); ?>
	...
	<div id="primary" class="content-area <?php echo ( get_theme_mod( 'ddchi-blog-cat-full-width' ) ) ? sanitize_html_class( 'content-area-full' ) : ''; ?>">
	...
	<?php if ( get_theme_mod( 'ddchi-blog-cat-full-width' ) ) : ?>
        <!-- No Sidebar -->
    <?php else : ?>
        <?php get_sidebar(); ?>
    <?php endif; ?>
