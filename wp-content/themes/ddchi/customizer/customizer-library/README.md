...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'ddchi' ), // Required
...
$options['example-text'] = array(
	'id' => 'example-text',
	'label'   => __( 'Example Text Input', 'ddchi' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'ddchi' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'ddchi' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'ddchi' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-content'] = array(
	'id' => 'example-content',
	'label' => __( 'Example Content', 'ddchi' ),
	'section' => $section,
	'type' => 'content',
	'content' => '<p>' . __( 'Content to output. Use <a href="#">HTML</a> if you like.', 'ddchi' ) . '</p>',
	'description' => __( 'Optional: Example Description.', 'ddchi' )
);
~~~
