...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'ddchi' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'ddchi' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'ddchi' ),
		'cyrillic'     => __( 'Cyrillic', 'ddchi' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'ddchi' ),
		'devanagari'   => __( 'Devanagari', 'ddchi' ),
		'greek'        => __( 'Greek', 'ddchi' ),
		'greek-ext'    => __( 'Greek Extended', 'ddchi' ),
		'khmer'        => __( 'Khmer', 'ddchi' ),
		'latin'        => __( 'Latin', 'ddchi' ),
		'latin-ext'    => __( 'Latin Extended', 'ddchi' ),
		'vietnamese'   => __( 'Vietnamese', 'ddchi' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'ddchi' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'ddchi' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'ddchi' ),
