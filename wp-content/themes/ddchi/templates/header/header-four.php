 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-four header-boxed-in <?php echo ( get_theme_mod( 'ddchi-set-header-nav-center-align' ) ) ? sanitize_html_class( 'site-header-nav-center' ) : ''; ?> <?php echo ( get_theme_mod( 'ddchi-set-header-align-right' ) ) ? sanitize_html_class( 'site-header-align-right' ) : ''; ?>">
            ...
            <div class="site-container">
                ...
                <div class="header-top-bar-right">
                    ...
                    <?php if ( get_theme_mod( 'ddchi-set-text-header-add' ) ) : ?>
                        <span class="header-top-bar-right-ad"><i class="fa fa-map-marker"></i> <?php echo wp_kses_post( get_theme_mod( 'ddchi-set-text-header-add' ), __( 'Cape Town, South Africa', 'ddchi' ) ); ?></span>
                    <?php endif; ?>
                        ...
                        <div class="header-cart">
                            ...
                            <a class="header-cart-contents" href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'ddchi' ); ?>">
                                <span class="header-cart-amount">
                                    <?php echo sprintf( _n( '%d items', '%d items', $woocommerce->cart->cart_contents_count, 'ddchi' ), $woocommerce->cart->cart_contents_count ); ?> <?php echo $woocommerce->cart->get_cart_total(); ?>
                                </span>
    ...
    <nav id="site-navigation" class="main-navigation <?php echo ( get_theme_mod( 'ddchi-remove-nav-shadow' ) ) ? sanitize_html_class( 'no-shadow' ) : ''; ?> <?php echo ( get_theme_mod( 'ddchi-set-navigation-style' ) ) ? sanitize_html_class( get_theme_mod( 'ddchi-set-navigation-style' ) ) : sanitize_html_class( 'ddchi-navigation-style-underline' ); ?>" role="navigation">
        ...
        <div class="site-container">
            ...
            <div id="main-menu" class="main-menu-container">
                ...
                <?php wp_nav_menu( array( 'theme_location' => 'ddchi-main-menu' ) ); ?>
                <div class="clearboth"></div>
            </div>
