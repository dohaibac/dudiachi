 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-three <?php echo ( get_theme_mod( 'ddchi-set-header-align-right' ) ) ? sanitize_html_class( 'site-header-align-right' ) : ''; ?>">
    ...
    <div class="header-bar <?php echo ( get_theme_mod( 'ddchi-set-header-v-align' ) ) ? sanitize_html_class( 'header-v-align' ) : ''; ?>">
                ...
                <div class="site-header-main">
                    ...
                    <div class="header-meta">
                        ...
                        <?php if ( get_theme_mod( 'ddchi-set-text-header-add' ) ) : ?>
                            <span class="header-top-bar-ad"> <?php echo wp_kses_post( get_theme_mod( 'ddchi-set-text-header-add' ), __( 'Copyright DuDiaChi', 'ddchi' ) ); ?></span>
                        <?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'ddchi-set-text-header-phone' ) ) : ?>
                            <span class="header-top-bar-no"><i class="fa fa-phone"></i> <?php echo wp_kses_post( get_theme_mod( 'ddchi-set-text-header-phone' ), __( 'Call Us: +2782 444 YEAH', 'ddchi' ) ); ?></span>
                        <?php endif; ?>
